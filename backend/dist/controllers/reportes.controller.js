...
exports.reportesController = {
    ...
    getConsumoEmpleados: async (req, res) => {
        try {
      ...
      `;
            ...
            throw new error_middleware_1.AppError('Error al generar reporte de consumos', 500);
        }
    },
    // Reporte detallado de transacciones
    getTransaccionesDetalladas: async (req, res) => {
        try {
            const { fecha_inicio, fecha_fin } = req.query;
            let query = `
        SELECT 
      ...
      `;
            ...
            throw new error_middleware_1.AppError('Error al generar reporte de transacciones detalladas', 500);
        }
    }
};
