...
router.get('/proveedores', (0, permisos_middleware_1.requireAnyPermission)('productos.ver', 'compras.ver'), productos_controller_1.productosController.getProveedores);
