  ...
  solicitar: async (req: AuthRequest, res: Response): Promise<void> => {
    ...
    try {
      ...
      const devInsertRes = await client.query(
        `INSERT INTO devolucion (solicitud_entrega_id, empleado_id, usuario_entrega_id, devolucion_motivo, devolucion_estado) 
         VALUES ($1, $2, $3, $4, 'pendiente') RETURNING devolucion_id`,
        [solicitud_entrega_id, solicitud.empleado_id, usuarioEntregaId, motivo.trim()]
      );
